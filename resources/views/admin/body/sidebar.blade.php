    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="{{ route('add.roles.permission') }}"><i class='bx bx-radio-circle'></i>Assign Role &
                        Permission </a>
                </li>

                <li><a href="{{ route('view.roles.permission') }}"><i class='bx bx-radio-circle'></i>View Role &
                        Permission </a>
                </li>
