...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/password/change/password',
        [UserController::class, 'ChangePasswordStore'])->name('password.change.store');
...
Route::middleware(['auth', 'roles:admin'])->group(function () {
    ...
    Route::post('/admin/password/update',
        [AdminController::class, 'AdminPasswordUpdate'])->name('admin.password.update');
...
/// Booking Report All Route
    ...
    Route::controller(RoleController::class)->group(function () {
        ...
        Route::get('/add/roles/permission', 'AssignRolesPermission')->name('add.roles.permission');
        Route::post('/role/permission/store', 'RolePermissionStore')->name('role.permission.store');
        Route::get('/view/roles/permission', 'ViewRolesPermission')->name('view.roles.permission');

        Route::get('/edit/assign/permission/{id}', 'EditAssignPermission')->name('edit.assign.permission');
        Route::post('/update/assign/permission/{id}', 'RolePermissionUpdate')->name('update.assign.permission');
        Route::get('/admin/delete/roles/{id}', 'RolePermissionDelete')->name('delete.assign.permission');
